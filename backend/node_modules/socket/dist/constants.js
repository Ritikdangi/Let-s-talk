...
let _Sentry
const LAZY_ENV = () => {
  const { envAsBoolean, envAsString } = require$1(
    '../external/@socketsecurity/registry/lib/env'
  )
  const { env } = process
  ...
  return Object.freeze({
    ...
    INLINED_SOCKET_CLI_VERSION: envAsString('0.15.5'),
    // Comp-time inlined Socket package version hash.
    // The '@rollup/plugin-replace' will replace "process.env['INLINED_SOCKET_CLI_VERSION_HASH']".
    INLINED_SOCKET_CLI_VERSION_HASH: envAsString('0.15.5:56b8dc4:7cdd3b64:pub'),
  ...
  if (!dataHome) {
    if (WIN32) {
      const logger = require$1(
        '../external/@socketsecurity/registry/lib/logger'
      )
...
//# debugId=3ab9f5bf-07ef-40ec-83c1-abd34d50be2f
